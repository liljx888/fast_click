...
def create_gui():
    ...
    theme_button.place(x=360, y=10)  # 根据新窗口宽度调整位置
    ...
    left_key_entry = tk.Entry(left_frame, width=15)  # 输入框宽度缩小
    ...
    # ===== 底部按钮区域 =====
    tk.Button(root, text="💾 保存设置", command=save_settings).grid(row=2, column=0, pady=15)
